table1 = bfrt.p4mite_new.pipe.SwitchIngress.ipv4_lpm
...
table2 = bfrt.p4mite_new.pipe.SwitchIngress.LB
entry = table2.entry_with_LB_forward(dst_addr=0x0A320064).push()
table3 = bfrt.p4mite_new.pipe.SwitchIngress.available_server_table
entry = table3.entry_with_available_server_action(dst_addr=0x0A320064).push()

DIP_table = bfrt.p4mite_new.pipe.SwitchIngress.DIP_table
